...
const implementationProvider_1 = require("../../src/features/implementationProvider");
...
suite(`${implementationProvider_1.default.name}: ${testAssetWorkspace_1.default.description}`, () => {
    let fileUri;
    suiteSetup(function () {
    ...
    test("Returns the implementation", () => __awaiter(void 0, void 0, void 0, function* () {
        let implementationList = (yield vscode.commands.executeCommand("vscode.executeImplementationProvider", fileUri, new vscode.Position(4, 22)));
        chai_1.expect(implementationList.length).to.be.equal(2);
    }));
});
//# sourceMappingURL=implementationProvider.test.js.map